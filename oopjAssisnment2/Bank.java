...
class BankTest{
    ...
    public void accInfo(){
        System.out.println("Account holder's name is  "+b.getAccHolderName());
        System.out.println("Account number is  "+b.getAccNumber());
        System.out.println("Account balance is "+b.getAccBalance());
    }
    public void displayAccBalance(){
        System.out.println("Enter Account number is ");
